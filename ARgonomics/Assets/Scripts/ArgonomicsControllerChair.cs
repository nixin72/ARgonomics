...
public class ArgonomicsControllerChair : MonoBehaviour
{
    /// <summary>
            ...
            else
            {
                ...
                if (gameObjects.Count == 0 || gameObjects.Count == 1)
                {
                    ...
                    if (gameObjects.Count == 2)
                    {
                        ...
                        var playerHeight = int.Parse(PlayerPrefs.GetString("Height"));
                        var adjustmentHeight = (distance * 100 - (3 * playerHeight / 11) - 10 / 11);

                        if (adjustmentHeight > 0)
                        {
                            _ShowAndroidToastMessage("Please lower the chair by " + System.Math.Abs(adjustmentHeight) + "cm");
                        } else
                        {
                            _ShowAndroidToastMessage("Please raise the chair by " + System.Math.Abs(adjustmentHeight) + "cm");
                        }
                    }
                }
                else
